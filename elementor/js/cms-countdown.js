( function( $ ) {
    ...
    var WidgetCountdownTimeHandler = function( $scope, $ ) {
        $scope.find(".cms-countdown").each(function(){
            $('.cms-countdown-bar').each(function () {
                var $this = $(this);
                var div = $this;
    ...
    $( window ).on( 'elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/cms_countdown.default', WidgetCountdownTimeHandler );
    } );
} )( jQuery );