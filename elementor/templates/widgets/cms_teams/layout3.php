            ...
            <div <?php soapee_slick_slider_settings($widget); ?>>
                <?php foreach ($settings['teams'] as $team): ?>
                        <div class="cms-team-item cms-slick-slide slick-slide">
                            <div class="cms-team-item-inner overflow-hidden text-center">
                                <div class="team-image relative overflow-hidden cms-transition"><?php
                                        soapee_image_by_size([
                                            'id'        => $team['team_image']['id'], 
                                            'size'      => $img_size,
                                            'class'     => 'team-img circle',
                                            'img_class' => 'circle',
                                            'default'   => true,
                                            'before'    => '',
                                            'after'     => ''
                                ...
                                <div class="team-content p-25">
                                    ...
                                    <div class="team-job font-500"><?php echo esc_html($team['team_job'])?></div>
                                    <div class="team-socials cms-transition mt-20 clearfix">
                                        <div class="team-social cms-social cms-social-style3">
                                            <?php
