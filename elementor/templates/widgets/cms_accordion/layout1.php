    ...
    <div id="<?php echo esc_attr($html_id); ?>" class="cms-accordion cms-accordion-layout1">
        <?php foreach ($accordions as $key => $value):
            ...
            $widget->add_render_attribute( $title_key, [
                'class' => [ 'cms-ac-title-text text-20 font-600 heading text-va-20 text-primary col' ],
            ] );
        ...
        ?>
            <div class="cms-accordion-item">
                <<?php etc_print_html($title_html_tag); ?> class="cms-ac-title row gutters-20 justify-content-between <?php echo esc_attr($is_active?'active':''); ?>" data-target="<?php echo esc_attr('#' . $_id); ?>">
