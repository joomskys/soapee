 ...
 */
?>
<div id="post-<?php the_ID(); ?>" <?php post_class('single-hentry archive'); ?>>
    <div class="entry-holder">
        <?php soapee_archive_meta(); ?>
    ...
    <?php if (has_post_format('gallery')) : ?>
        <div class="entry-featured">
            ...
            $gallery_list = explode(',', soapee_get_post_format_value('post-gallery-images', ''));
            wp_enqueue_script( 'owl-carousel' );
            wp_enqueue_script( 'soapee-carousel' );
            ?>
    ...
    <?php elseif (has_post_format('quote')) : ?>
        <div class="entry-featured">
            <?php
                $quote_text = soapee_get_post_format_value('post-quote-cite', '');
    ...
    <?php elseif (has_post_format('link')) : ?>
        <div class="entry-featured">
            <?php
                $link_pf = soapee_get_post_format_value('post-link-url', '#');
    ...
    <?php elseif (has_post_format('video')) : ?>
        <div class="entry-featured">
            <div class="entry-video featured-active">
                <?php
                $video_url = soapee_get_post_format_value('post-video-url', '#');
                $video_file = soapee_get_post_format_value('post-video-file', '');
                $video_html = soapee_get_post_format_value('post-video-html', '');
                $video = '';
                if (!empty($video_url)) {
                    global $wp_embed;
    ...
    <?php elseif (has_post_format('audio')) : ?>
        <div class="entry-featured">
            <?php
                $audio_url = soapee_get_post_format_value('post-audio-url', '#');
