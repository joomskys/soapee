 ...
 * @return string
 */
function soapee_get_theme_opt_name()
{
    return apply_filters('soapee_theme_opt_name', 'cms_theme_options');
}
 ...
 * @return mixed
 */
function soapee_get_theme_opt($opt_id, $default = false){
    $opt_name      = soapee_get_theme_opt_name();
    if (empty($opt_name)) {
        return $default;
    }
    global ${$opt_name};
 ...
 * @return string
 */
function soapee_get_page_opt_name() {
	return apply_filters( 'soapee_page_opt_name', 'cms_page_options' );
}
/**
 * Get theme option based on its id.
 *
 ...
 * @return mixed
 */
function soapee_get_page_opt($opt_id, $default = false)
{
    $page_opt_name = soapee_get_page_opt_name();
 ...
 * @return mixed
 */
function soapee_get_page_opt_old( $opt_id, $default = false ) {
	$page_opt_name = soapee_get_page_opt_name();
	if ( empty( $page_opt_name ) ) {
		return $default;
	}
 ...
 * @return mixed
 */
function soapee_get_opts($opt_id, $default = false){
    $theme_opt = soapee_get_theme_opt($opt_id, $default);
    $page_opt  = soapee_get_page_opt($opt_id, $theme_opt);
 ...
 * @return bool|mixed
 */
function soapee_get_post_format_value($id=null,$post_format_key, $default = '')
{
    global $post;
