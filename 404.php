                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                        ...
                        <div class="page-404-description mb-45"><?php 
                            echo esc_attr(soapee_get_opt( 'content_404_page', esc_html__('The page you are looking is not available or has been removed. Try going to Home Page by using the button below.', 'soapee') ));
                        ?></div>
